...
s1=aggregate(meaneduc~Target, new_train1, mean)
s1
...
new_train1$wall<-NA
new_train1$floor<-NA
new_train1$wall[new_train1$epared1 == 1] = 'Bad'
new_train1$wall[new_train1$epared2 == 1] = 'Regular'
new_train1$wall[new_train1$epared3 == 1] = 'Good'

new_train1$roof[new_train1$etecho1 == 1] = 'Bad'
new_train1$roof[new_train1$etecho2== 1] = 'Regular'
new_train1$roof[new_train1$etecho3== 1] = 'Good'

new_train1$floor[new_train1$eviv1 == 1] = 'Bad'
new_train1$floor[new_train1$eviv2 == 1] = 'Regular'
new_train1$floor[new_train1$eviv3 == 1] = 'Good'
