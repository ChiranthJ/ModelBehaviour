...
#plotting a correlation matrix to show
...
p<-ggplot(data=s, aes(x=Target, y=v2a1)) +
  geom_bar(stat="identity",fill="orange")+coord_flip()+labs(title = "Relation between average monthly rent for a Poverty Class", y = "Monthly Rent Payment", x = "Target")
p
```
...
ggplot(target, aes(x = v2a1, y = age)) +
    geom_point((aes(color = factor(Target))))+labs(title = "Plot between age of the house and monthly rent", x = "Monthly Rent", y = "Age of Household")
```
